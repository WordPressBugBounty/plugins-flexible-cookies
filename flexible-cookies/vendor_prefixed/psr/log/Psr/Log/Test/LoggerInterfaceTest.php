...
namespace FlexibleCookiesVendor\Psr\Log\Test;

use FlexibleCookiesVendor\Psr\Log\LoggerInterface;
use FlexibleCookiesVendor\Psr\Log\LogLevel;
use FlexibleCookiesVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FlexibleCookiesVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FlexibleCookiesVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FlexibleCookiesVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
