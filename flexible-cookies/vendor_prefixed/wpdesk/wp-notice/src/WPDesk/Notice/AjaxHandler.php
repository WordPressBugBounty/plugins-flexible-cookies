...
namespace FlexibleCookiesVendor\WPDesk\Notice;

use FlexibleCookiesVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use FlexibleCookiesVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
