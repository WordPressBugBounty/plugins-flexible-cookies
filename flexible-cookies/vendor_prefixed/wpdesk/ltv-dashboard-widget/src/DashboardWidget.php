...
namespace FlexibleCookiesVendor\WPDesk\Dashboard;

final class DashboardWidget
{
    const ID = 'flexible-cookies';
    ...
    {
        return __('Grow your business with WP Desk', 'flexible-cookies');
    }
    ...
    public function widget_output()
    {
        ...
        if (!empty($widget_data)) {
            echo '<div class="flexible-cookies">';
    ...
    private function show_plugins(array $plugins, bool $for_free = \false)
    {
        ...
        foreach ($plugins as $plugin) {
            ...
            $add_to_cart_button_label = esc_html__('Buy now', 'flexible-cookies');
            if ($plugin['add_to_cart_id'] === self::WP_DESK_CARE_ID) {
                $add_to_cart_button_label = esc_html__('Learn more', 'flexible-cookies');
                $add_to_cart_url = $plugin_url;
            } else if ($plugin['add_to_cart_id'] === self::AUTOPAY_ID) {
                $add_to_cart_button_label = esc_html__('Download', 'flexible-cookies');
            ...
            if ($for_free) {
                echo '<a class="button button-primary" href="' . \esc_url($plugin_url) . '" target="_blank">' . esc_html__('More info', 'flexible-cookies') . '</a>';
