...
<h2><?php 
\printf(\esc_html__('You are deactivating %s plugin.', 'flexible-cookies'), \esc_html($plugin_name));
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\esc_html_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'flexible-cookies');
?></strong></h4>
			<ul id="reasons-list">
				<li class="reason">
					<label>
					<span>
						...
						<span><?php 
\esc_html_e('The plugin suddenly stopped working', 'flexible-cookies');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('The plugin broke my site', 'flexible-cookies');
?></span>
					</label>
				</li>
				<li class="reason has-input">
					<label>
						...
						<span><?php 
\esc_html_e('I found a better plugin', 'flexible-cookies');
?></span>
					</label>
					<div id="found_better_plugin" class="reason-input">
						<input type="text" name="better_plugin_name" placeholder="<?php 
\esc_html_e('What\'s the plugin\'s name?', 'flexible-cookies');
?>">
					</div>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('I only needed the plugin for a short period', 'flexible-cookies');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('I no longer need the plugin', 'flexible-cookies');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'flexible-cookies');
?></span>
					</label>
				</li>
				<li class="reason has-input">
					...
					<span>
						...
						<span><?php 
\esc_html_e('Other', 'flexible-cookies');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\esc_attr_e('Kindly tell us the reason so we can improve', 'flexible-cookies');
?>">
					</div>
				</li>
			</ul>
...
\esc_html_e('Cancel', 'flexible-cookies');
?></a>
		<a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\esc_html_e('Skip &amp; Deactivate', 'flexible-cookies');
?></a>
	</div>
</div>
...
\esc_html_e("Submit &amp; Deactivate", "flexible-cookies");
?>' );
	})
