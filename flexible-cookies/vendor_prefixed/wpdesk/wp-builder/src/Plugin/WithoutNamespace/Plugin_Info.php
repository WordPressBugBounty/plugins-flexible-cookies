...
if (!\interface_exists('FlexibleCookiesVendor\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('FlexibleCookiesVendor\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FlexibleCookiesVendor\WPDesk_Has_Plugin_Info')) {
