...
namespace FlexibleCookiesVendor\WPDesk\PluginBuilder\Builder;
...
use FlexibleCookiesVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\FlexibleCookiesVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
