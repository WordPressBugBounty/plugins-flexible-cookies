...
?>">
			<?php 
\esc_html_e('Set image', 'flexible-cookies');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'flexible-cookies');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'flexible-cookies');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'flexible-cookies');
?>"
				},
				library: {
					type: ['image']
