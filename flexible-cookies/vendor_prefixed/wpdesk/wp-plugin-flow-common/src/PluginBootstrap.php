...
namespace FlexibleCookiesVendor\WPDesk\Plugin\Flow;

use FlexibleCookiesVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-cookies';
     ...
     */
    private function init_translations(\FlexibleCookiesVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \FlexibleCookiesVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \FlexibleCookiesVendor\WPDesk_Plugin_Info();
